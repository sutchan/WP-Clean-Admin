...
| 版本 | 日期 | 变更内容 |
|------|------|----------|
| 1.8.3 | 2026-08-08 | 增补 AJAX 接口标准（统一网关 _wpnonce/wpca_ajax_nonce、错误码、已注册 action、业务数据结构）、设置模块数据结构；同步模块化架构命名空间 |
...
- GitHub Issues：https://github.com/Tanox/WP-Clean-Admin/issues
