# 更新所有JavaScript文件的头部注释，添加更新日期
$currentDate = Get-Date -Format "yyyy-MM-dd"

# 获取所有JavaScript文件
$jsFiles = Get-ChildItem -Path "e:\Dropbox\GitHub\WPCleanAdmin\wpcleanadmin\assets\js" -Filter "*.js" -Recurse
